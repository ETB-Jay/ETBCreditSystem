...
function EmailInfo() {
    ...
    return (
        <div className="flex flex-row items-center justify-start max-w-1/3 h-2/3 select-none">
            ...
            <div className="text-white font-semibold text-[0.8rem] md:text-[1rem] lg:text-[1.1rem] max-w-8 md:max-w-25 lg:max-w-none overflow-x-scroll no-scroll">{customer.email ? customer.email : "N/A"}</div>
        </div>
    )
}
