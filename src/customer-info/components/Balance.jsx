...
function Balance() {
    ...
    return (
        <div className="flex flex-row items-center justify-between w-fit md:min-w-40 bg-gray-400 rounded-2xl h-full select-none hover:bg-gray-500 ring-2 cursor-pointer" onClick={()=>setDisplay('transaction')}>
