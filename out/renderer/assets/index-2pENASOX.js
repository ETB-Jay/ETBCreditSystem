...
const CustomerContext = reactExports.createContext();
CustomerContext.displayName = "CustomerContext";
const DisplayContext = reactExports.createContext("default");
DisplayContext.displayName = "DisplayContext";
const CustomerNamesContext = reactExports.createContext();
CustomerNamesContext.displayName = "CustomerNamesContext";
const TransactionContext = reactExports.createContext();
...
const useDisplay = () => {
  const context = reactExports.useContext(DisplayContext);
  if (!context) {
...
const useCustomerNames = () => {
  const context = reactExports.useContext(CustomerNamesContext);
  if (!context) {
...
const useTransactions = () => {
  const context = reactExports.useContext(TransactionContext);
  if (!context) {
...
function AddCustomer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "ml-0.5 stroke-white hover:brightness-50 cursor-pointer",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "svg",
        {
          ...
          stroke: "inherit",
          className: "size-6",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 4.5v10m5-5h-10" })
        }
      )
    }
  );
...
function ListDisplay({ filter = "" }) {
  ...
  const filteredRows = customers.filter(
    (row) => row && Object.keys(row).length > 1 && ((row.first_name?.toLowerCase() || "").includes(filter.toLowerCase()) || (row.last_name?.toLowerCase() || "").includes(filter.toLowerCase()))
  );
  const handleClick = (row, index2) => {
    setCustomer(row);
    setSelectedIndex(index2);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-none p-0 m-0 overflow-y-auto container-snap", children: filteredRows.map((row, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "li",
    {
      className: `flex flex-row items-center justify-between text-[0.8rem] 
                    ...
                    ${selectedIndex === index2 ? "bg-[#2e2e2e] font-bold" : "odd:bg-[#c1c1c143] even:bg-[#ffffff55]"}`,
      onClick: () => handleClick(row, index2),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "overflow-x-scroll container-snap", children: `${row.last_name}, ${row.first_name}` }),
        row.balance < 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(WarningIcon, { sx: { fontSize: "100%" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {})
      ]
    },
    index2
  )) }) });
...
function Search() {
  ...
  const { setDisplay } = useDisplay();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex align-center justify-center flex-col bg-[#303030] p-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center mb-1.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AddCustomer, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoIcon, { className: "cursor-pointer hover:brightness-50", onClick: () => setDisplay("report"), sx: { color: "white", fontSize: "20px" } })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ListDisplay, { filter: search })
  ] });
}
function AskModify() {
  const { setDisplay } = useDisplay();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        display === "option" && /* @__PURE__ */ jsxRuntimeExports.jsx(AskModify, {})
      ]
    }
  );
}
...
function EmailInfo() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-start w-2/7 h-full mr-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(EmailIcon, { className: "mr-2", sx: { color: "white", fontSize: "min(5vw, 5vh, 30px)" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold text-[0.8rem] md:text-[1rem] lg:text-[1.1rem] overflow-x-auto container-snap", children: customer.email ? customer.email : "N/A" })
  ] });
}
...
function PhoneInfo() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-start h-full mr-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneIcon, { className: "mr-2", sx: { color: "white", fontSize: "min(5vw, 5vh, 30px)" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold text-[0.8rem] md:text-[1rem] lg:text-[1.1rem] whitespace-nowrap overflow-x-auto container-snap", children: formatPhoneNumber(customer.phone) })
  ] });
}
...
function Balance() {
  ...
  const [formattedBalance, setFormattedBalance] = reactExports.useState("0.00");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-between w-2/3 h-full sm:pl-1 sm:pr-5 md:pr-3 md:pl-5 lg:px-5 bg-gray-400 rounded-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AttachMoneyIcon, { className: "mr-2", sx: { color: "black", fontSize: "3vw" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-black font-bold text-[0.9rem] md:text-[1.2rem] lg:text-[1.5rem] overflow-x-auto container-snap", children: formattedBalance })
    ] }),
    Number(formattedBalance) < 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(WarningIcon, { fontSize: "small" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {})
  ] }) });
}
const icon = "" + new URL("ETBBanner-CA0PY5YK.png", import.meta.url).href;
const FilterListIcon = createSvgIcon(/* @__PURE__ */ jsxRuntimeExports.jsx("path", {
  d: "M10 18h4v-2h-4zM3 6v2h18V6zm3 7h12v-2H6z"
}));
const FilterContainer = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-fit bg-[#d7e2f5] border-3 border-gray-500 hover:bg-[#bacbe8] rounded p-1", children });
FilterContainer.propTypes = {
  children: PropTypes.node.isRequired
};
const FilterField = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 p-1 min-w-[100px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1", children }) });
FilterField.propTypes = {
  children: PropTypes.node.isRequired
};
const FilterLabel = ({ label }) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs lg:text-sm font-medium", children: label });
...
function DateFilter({ onFilterChange, values: values2 }) {
  const handleDateChange = (type, value) => {
    if (onFilterChange) {
      onFilterChange({
        startDate: type === "start" ? value : values2.startDate,
        endDate: type === "end" ? value : values2.endDate
      });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterField, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { label: "Start Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FilterInput,
        {
          type: "date",
          value: values2.startDate,
          onChange: (e) => handleDateChange("start", e.target.value)
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterField, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { label: "End Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FilterInput,
        {
          type: "date",
          value: values2.endDate,
...
function Amount({ onFilterChange, values: values2 }) {
  const handleAmountChange = (type, value) => {
    const numericValue = value.replace(/[^0-9.-]/g, "");
    if (onFilterChange) {
      onFilterChange({
        minAmount: type === "min" ? numericValue : values2.minAmount,
        maxAmount: type === "max" ? numericValue : values2.maxAmount
      });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterField, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { label: "Minimum Amount" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-row items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 mr-2", children: "$" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FilterInput,
          {
            type: "text",
            value: values2.minAmount,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterField, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { label: "Maximum Amount" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-row items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 mr-2", children: "$" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FilterInput,
...
function EmployeeName({ onFilterChange, values: values2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FilterContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(FilterField, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { label: "Employee Name" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FilterInput,
      {
        type: "text",
        value: values2.searchTerm,
...
function TableDisplay() {
  ...
  const handleFilterChange = (filterType, values2) => {
    setFilters((prev2) => ({
      ...prev2,
      [filterType]: values2
    }));
  ...
  const hasActiveFilters = () => {
    return filters.date.startDate || filters.date.endDate || filters.amount.minAmount || filters.amount.maxAmount || filters.employee.searchTerm;
  };
  if ((!filteredRows || filteredRows.length === 0) && !hasActiveFilters()) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full items-center justify-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "absolute text-white z-10 font-bold text-2xl mg:text-3x1 lg:text-4xl bg-black/50 rounded-xl p-5 select-none", children: "NO TRANSACTIONS YET" })
    ] });
  }
  const HeaderField = ({ label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("th", { className: "relative px-3 py-1 font-semibold whitespace-nowrap cursor-pointer group", children: [
    ...
    display === "DateFilter" && label === "Date" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-50 mt-1 left-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      DateFilter,
      {
        onFilterChange: (values2) => handleFilterChange("date", values2),
        values: filters.date
      }
    ) }),
    display === "AmountFilter" && label === "Amount" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-50 mt-1 left-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Amount,
      {
        onFilterChange: (values2) => handleFilterChange("amount", values2),
        values: filters.amount
      }
    ) }),
    display === "EmployeeFilter" && label === "Employee" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-50 mt-1 left-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmployeeName,
      {
        onFilterChange: (values2) => handleFilterChange("employee", values2),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs md:text-sm lg:text-[1rem] text-black", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-[#808080] top-0 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left text-black", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderField, { label: "Date" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderField, { label: "Amount" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderField, { label: "Employee" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "w-1/3 px-3 py-1 font-semibold whitespace-nowrap", children: "Notes" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "overflow-y-scroll container-snap", children: filteredRows.map((row, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        className: row.change_balance < 0 ? "bg-red-300" : "bg-green-300",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-0.5 max-w-[120px] overflow-x-auto whitespace-nowrap container-snap", title: row.date, children: new Date(new Date(row.date).getTime()).toISOString().replace("T", " ").slice(0, 19) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-0.5 max-w-[120px] overflow-x-auto whitespace-nowrap container-snap", title: row.change_balance, children: [
            row.change_balance < 0 ? "-" : "",
            "$",
            Number(Math.abs(row.change_balance)).toFixed(2)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-0.5 max-w-[120px] overflow-x-auto whitespace-nowrap container-snap", title: row.employee_name, children: row.employee_name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pl-3 pr-0 py-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[230px] max-h-7 overflow-x-auto whitespace-nowrap container-snap", title: row.notes, children: row.notes }) })
        ]
      },
      idx
    )) })
...
function CustomerInfo() {
  ...
  if (Object.keys(customer).length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center flex-col bg-[#303030] p-2 justify-center w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "brightness-40 h-2/3 w-auto", src: icon, draggable: "false" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex align-center flex-col bg-[#303030] p-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid grid-cols-[95%_5%] sm:mb-[2vh] md:mb-[1vw] xl:mb-[0.5vw] md:h-1/12 ", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center ml-3 w-[95%]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(EmailInfo, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneInfo, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Balance, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Actions, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableDisplay, {})
  ] }) });
}
function commonjsRequire(path) {
  throw new Error('Could not dynamically require "' + path + '". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.');
}
var airtable_umd = { exports: {} };
var hasRequiredAirtable_umd;
function requireAirtable_umd() {
  if (hasRequiredAirtable_umd) return airtable_umd.exports;
  hasRequiredAirtable_umd = 1;
  (function(module, exports) {
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        if (!browserGlobal) {
          AbortController2 = require2("abort-controller");
      ...
      }, { "abort-controller": 20, "abortcontroller-polyfill/dist/cjs-ponyfill": 19 }], 2: [function(require2, module2, exports2) {
        var AirtableError = (
          /** @class */
          function() {
      ...
      }, { "./abort-controller": 1, "./airtable_error": 2, "./exponential_backoff_with_jitter": 6, "./fetch": 7, "./http_headers": 9, "./object_to_query_param_string": 11, "./package_version": 12, "./run_action": 16, "./table": 17, "lodash/get": 77, "lodash/isPlainObject": 89, "lodash/keys": 93 }], 4: [function(require2, module2, exports2) {
      ...
      }, { "./internal_config.json": 10 }], 7: [function(require2, module2, exports2) {
        var __importDefault = this && this.__importDefault || function(mod) {
          return mod && mod.__esModule ? mod : { "default": mod };
        };
      ...
      }, { "node-fetch": 20 }], 8: [function(require2, module2, exports2) {
          ...
          function() {
            ...
            HttpHeaders2.prototype.toJSON = function() {
              ...
              for (var _i = 0, _a = keys_1.default(this._headersByLowercasedKey); _i < _a.length; _i++) {
                ...
                if (isBrowser2 && lowercasedKey === "user-agent") {
      ...
      }, { "lodash/keys": 93 }], 10: [function(require2, module2, exports2) {
        module2.exports = {
          ...
          if (isArray_1.default(obj)) {
            for (var index2 = 0; index2 < obj.length; index2++) {
              ...
              if (/\[\]$/.test(prefix2)) {
                ...
                buildParams(prefix2 + "[" + (typeof value === "object" && value !== null ? index2 : "") + "]", value, addFn);
              }
            }
            ...
            for (var _i = 0, _a = keys_1.default(obj); _i < _a.length; _i++) {
              var key = _a[_i];
              var value = obj[key];
              buildParams(prefix2 + "[" + key + "]", value, addFn);
            }
          } else {
            addFn(prefix2, obj);
          }
      ...
      }, { "lodash/isArray": 79, "lodash/isNil": 85, "lodash/keys": 93 }], 12: [function(require2, module2, exports2) {
        module2.exports = "0.12.2";
      ...
      }, { "./callback_to_promise": 4, "./has": 8, "./object_to_query_param_string": 11, "./query_params": 14, "./record": 15, "lodash/isFunction": 83, "lodash/keys": 93 }], 14: [function(require2, module2, exports2) {
        var __importDefault = this && this.__importDefault || function(mod) {
          return mod && mod.__esModule ? mod : { "default": mod };
        };
      ...
      }, { "./typecheck": 18, "lodash/isBoolean": 81, "lodash/isNumber": 86, "lodash/isPlainObject": 89, "lodash/isString": 90 }], 15: [function(require2, module2, exports2) {
        var __assign = this && this.__assign || function() {
          __assign = Object.assign || function(t) {
            for (var s, i = 1, n = arguments.length; i < n; i++) {
              s = arguments[i];
      ...
      }, { "./callback_to_promise": 4 }], 16: [function(require2, module2, exports2) {
        var __importDefault = this && this.__importDefault || function(mod) {
          return mod && mod.__esModule ? mod : { "default": mod };
        };
        var exponential_backoff_with_jitter_1 = __importDefault(require2("./exponential_backoff_with_jitter"));
      ...
      }, { "./abort-controller": 1, "./exponential_backoff_with_jitter": 6, "./fetch": 7, "./object_to_query_param_string": 11, "./package_version": 12 }], 17: [function(require2, module2, exports2) {
        var __assign = this && this.__assign || function() {
          __assign = Object.assign || function(t) {
            for (var s, i = 1, n = arguments.length; i < n; i++) {
              s = arguments[i];
      ...
      }, { "./callback_to_promise": 4, "./deprecate": 5, "./object_to_query_param_string": 11, "./query": 13, "./query_params": 14, "./record": 15, "lodash/isPlainObject": 89 }], 18: [function(require2, module2, exports2) {
      ...
      }, { "./_hashClear": 46, "./_hashDelete": 47, "./_hashGet": 48, "./_hashHas": 49, "./_hashSet": 50 }], 22: [function(require2, module2, exports2) {
      ...
      }, { "./_listCacheClear": 56, "./_listCacheDelete": 57, "./_listCacheGet": 58, "./_listCacheHas": 59, "./_listCacheSet": 60 }], 23: [function(require2, module2, exports2) {
        var getNative = require2("./_getNative"), root = require2("./_root");
        var Map2 = getNative(root, "Map");
        module2.exports = Map2;
      }, { "./_getNative": 42, "./_root": 72 }], 24: [function(require2, module2, exports2) {
      ...
      }, { "./_mapCacheClear": 61, "./_mapCacheDelete": 62, "./_mapCacheGet": 63, "./_mapCacheHas": 64, "./_mapCacheSet": 65 }], 25: [function(require2, module2, exports2) {
        var root = require2("./_root");
        var Symbol2 = root.Symbol;
        module2.exports = Symbol2;
      }, { "./_root": 72 }], 26: [function(require2, module2, exports2) {
      ...
      }, { "./_baseTimes": 35, "./_isIndex": 51, "./isArguments": 78, "./isArray": 79, "./isBuffer": 82, "./isTypedArray": 92 }], 27: [function(require2, module2, exports2) {
      ...
      }, { "./eq": 76 }], 29: [function(require2, module2, exports2) {
      ...
      }, { "./_castPath": 38, "./_toKey": 74 }], 30: [function(require2, module2, exports2) {
      ...
      }, { "./_Symbol": 25, "./_getRawTag": 44, "./_objectToString": 70 }], 31: [function(require2, module2, exports2) {
      ...
      }, { "./_baseGetTag": 30, "./isObjectLike": 88 }], 32: [function(require2, module2, exports2) {
      ...
      }, { "./_isMasked": 54, "./_toSource": 75, "./isFunction": 83, "./isObject": 87 }], 33: [function(require2, module2, exports2) {
      ...
      }, { "./_baseGetTag": 30, "./isLength": 84, "./isObjectLike": 88 }], 34: [function(require2, module2, exports2) {
      ...
      }, { "./_isPrototype": 55, "./_nativeKeys": 68 }], 35: [function(require2, module2, exports2) {
      ...
      }, { "./_Symbol": 25, "./_arrayMap": 27, "./isArray": 79, "./isSymbol": 91 }], 37: [function(require2, module2, exports2) {
      ...
      }, { "./_isKey": 52, "./_stringToPath": 73, "./isArray": 79, "./toString": 96 }], 39: [function(require2, module2, exports2) {
        var root = require2("./_root");
        var coreJsData = root["__core-js_shared__"];
        module2.exports = coreJsData;
      }, { "./_root": 72 }], 40: [function(require2, module2, exports2) {
        (function(global2) {
      ...
      }, { "./_isKeyable": 53 }], 42: [function(require2, module2, exports2) {
        var baseIsNative = require2("./_baseIsNative"), getValue2 = require2("./_getValue");
        function getNative(object, key) {
          var value = getValue2(object, key);
          return baseIsNative(value) ? value : void 0;
        }
        module2.exports = getNative;
      }, { "./_baseIsNative": 32, "./_getValue": 45 }], 43: [function(require2, module2, exports2) {
        var overArg = require2("./_overArg");
        var getPrototype = overArg(Object.getPrototypeOf, Object);
        module2.exports = getPrototype;
      }, { "./_overArg": 71 }], 44: [function(require2, module2, exports2) {
      ...
      }, { "./_Symbol": 25 }], 45: [function(require2, module2, exports2) {
      ...
      }, { "./_nativeCreate": 67 }], 47: [function(require2, module2, exports2) {
      ...
      }, { "./_nativeCreate": 67 }], 49: [function(require2, module2, exports2) {
        var nativeCreate = require2("./_nativeCreate");
        var objectProto = Object.prototype;
        var hasOwnProperty = objectProto.hasOwnProperty;
      ...
      }, { "./_nativeCreate": 67 }], 50: [function(require2, module2, exports2) {
        var nativeCreate = require2("./_nativeCreate");
        var HASH_UNDEFINED = "__lodash_hash_undefined__";
      ...
      }, { "./_nativeCreate": 67 }], 51: [function(require2, module2, exports2) {
      ...
      }, { "./isArray": 79, "./isSymbol": 91 }], 53: [function(require2, module2, exports2) {
      ...
      }, { "./_coreJsData": 39 }], 55: [function(require2, module2, exports2) {
        var objectProto = Object.prototype;
      ...
      }, { "./_assocIndexOf": 28 }], 58: [function(require2, module2, exports2) {
        var assocIndexOf = require2("./_assocIndexOf");
      ...
      }, { "./_assocIndexOf": 28 }], 59: [function(require2, module2, exports2) {
        var assocIndexOf = require2("./_assocIndexOf");
        function listCacheHas(key) {
          return assocIndexOf(this.__data__, key) > -1;
        }
        module2.exports = listCacheHas;
      }, { "./_assocIndexOf": 28 }], 60: [function(require2, module2, exports2) {
        var assocIndexOf = require2("./_assocIndexOf");
      ...
      }, { "./_assocIndexOf": 28 }], 61: [function(require2, module2, exports2) {
      ...
      }, { "./_Hash": 21, "./_ListCache": 22, "./_Map": 23 }], 62: [function(require2, module2, exports2) {
      ...
      }, { "./_getMapData": 41 }], 63: [function(require2, module2, exports2) {
        var getMapData = require2("./_getMapData");
        function mapCacheGet(key) {
          return getMapData(this, key).get(key);
        }
        module2.exports = mapCacheGet;
      }, { "./_getMapData": 41 }], 64: [function(require2, module2, exports2) {
        var getMapData = require2("./_getMapData");
        function mapCacheHas(key) {
          return getMapData(this, key).has(key);
        }
        module2.exports = mapCacheHas;
      }, { "./_getMapData": 41 }], 65: [function(require2, module2, exports2) {
        var getMapData = require2("./_getMapData");
      ...
      }, { "./_getMapData": 41 }], 66: [function(require2, module2, exports2) {
        var memoize2 = require2("./memoize");
      ...
      }, { "./memoize": 94 }], 67: [function(require2, module2, exports2) {
        var getNative = require2("./_getNative");
        var nativeCreate = getNative(Object, "create");
        module2.exports = nativeCreate;
      }, { "./_getNative": 42 }], 68: [function(require2, module2, exports2) {
        var overArg = require2("./_overArg");
        var nativeKeys = overArg(Object.keys, Object);
        module2.exports = nativeKeys;
      }, { "./_overArg": 71 }], 69: [function(require2, module2, exports2) {
      ...
      }, { "./_freeGlobal": 40 }], 70: [function(require2, module2, exports2) {
        var objectProto = Object.prototype;
        var nativeObjectToString = objectProto.toString;
      ...
      }, { "./_freeGlobal": 40 }], 73: [function(require2, module2, exports2) {
      ...
      }, { "./_memoizeCapped": 66 }], 74: [function(require2, module2, exports2) {
      ...
      }, { "./isSymbol": 91 }], 75: [function(require2, module2, exports2) {
        ...
        module2.exports = get;
      }, { "./_baseGet": 29 }], 78: [function(require2, module2, exports2) {
      ...
      }, { "./_baseIsArguments": 31, "./isObjectLike": 88 }], 79: [function(require2, module2, exports2) {
      ...
      }, { "./isFunction": 83, "./isLength": 84 }], 81: [function(require2, module2, exports2) {
        var baseGetTag = require2("./_baseGetTag"), isObjectLike = require2("./isObjectLike");
      ...
      }, { "./_baseGetTag": 30, "./isObjectLike": 88 }], 82: [function(require2, module2, exports2) {
      ...
      }, { "./_root": 72, "./stubFalse": 95 }], 83: [function(require2, module2, exports2) {
      ...
      }, { "./_baseGetTag": 30, "./isObject": 87 }], 84: [function(require2, module2, exports2) {
        var MAX_SAFE_INTEGER = 9007199254740991;
      ...
      }, { "./_baseGetTag": 30, "./isObjectLike": 88 }], 87: [function(require2, module2, exports2) {
      ...
      }, { "./_baseGetTag": 30, "./_getPrototype": 43, "./isObjectLike": 88 }], 90: [function(require2, module2, exports2) {
      ...
      }, { "./_baseGetTag": 30, "./isArray": 79, "./isObjectLike": 88 }], 91: [function(require2, module2, exports2) {
        var baseGetTag = require2("./_baseGetTag"), isObjectLike = require2("./isObjectLike");
      ...
      }, { "./_baseGetTag": 30, "./isObjectLike": 88 }], 92: [function(require2, module2, exports2) {
      ...
      }, { "./_baseIsTypedArray": 33, "./_baseUnary": 37, "./_nodeUtil": 69 }], 93: [function(require2, module2, exports2) {
      ...
      }, { "./_arrayLikeKeys": 26, "./_baseKeys": 34, "./isArrayLike": 80 }], 94: [function(require2, module2, exports2) {
      ...
      }, { "./_MapCache": 24 }], 95: [function(require2, module2, exports2) {
        function stubFalse() {
          return false;
        }
      ...
      }, { "./_baseToString": 36 }], "airtable": [function(require2, module2, exports2) {
        var __importDefault = this && this.__importDefault || function(mod) {
          return mod && mod.__esModule ? mod : { "default": mod };
        };
  ...
  return airtable_umd.exports;
}
var airtable_umdExports = requireAirtable_umd();
const Airtable = /* @__PURE__ */ getDefaultExportFromCjs(airtable_umdExports);
const base = new Airtable({ apiKey: "patgkDlHzz9NCT2HR.58608f187bfe09d146d2771f2b0469ab4766a00251716d57c7a974dca3a8faba" }).base("app28LKBbucKolmAc");
const customerTable = "tbleLNBKMn2GoNtBq";
const transactionTable = "tbl7u5s8vcGkaOckb";
...
const Prompt = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 flex items-center justify-center z-10 backdrop-blur-[2px] transition-normal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center rounded-xl bg-gray-900/95 h-fit w-2/3 md:w-7/12 lg:w-1/2 xl:w-1/3 p-4 border border-white/20 shadow-xl", children }) });
Prompt.propTypes = {
  children: PropTypes.node.isRequired
};
const PromptTitle = ({ label }) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg mb-2 select-none", children: label });
PromptTitle.propTypes = {
  label: PropTypes.string.isRequired
};
const PromptField = ({ label, children, error = void 0 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-full mb-3", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm min-w-[110px] text-right select-none", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children })
  ] }),
  error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-400 text-xs ml-[136px] select-none", children: error }) : null
] });
...
const PromptInput = ({ value, onChange, type = "text", step, disabled, name, placeholder }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "input",
  {
    className: "text-white text-[0.8rem] bg-white/15 rounded-md px-3 py-1.5 h-7 w-full outline-none transition-colors focus:bg-white/20 hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed",
    type,
    step,
    value: value || "",
    onChange,
...
const PromptButton = ({ onClick, disabled, children }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "button",
  {
    className: `text-sm font-bold bg-white/50 rounded-md px-4 py-1.5 w-fit cursor-pointer transition-colors select-none hover:bg-white/60 active:bg-white/40 disabled:opacity-50 disabled:cursor-not-allowed`,
    onClick,
    disabled,
    children
  }
...
function CustomerPrompt() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Prompt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptTitle, { label: "Add a New Customer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "First Name", error: errors.first_name, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Last Name", error: errors.last_name, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Email", error: errors.email, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
        type: "email",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Phone", error: errors.phone, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
        type: "tel",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PromptButton,
        {
          ...
          disabled: isSubmitting,
          children: isSubmitting ? "Processing..." : "Save Changes"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PromptButton,
...
function TransactionPrompt() {
  ...
  const [newTransaction, setNewTransaction] = reactExports.useState({});
  const { setDisplay } = useDisplay();
  const [errors, setErrors] = reactExports.useState({
    insufficient: "",
    noEmployee: ""
  });
  const [isSubmitting, setIsSubmitting] = reactExports.useState();
  const [payment, setPayment] = reactExports.useState({ add: false, sub: false });
  const { setCustomers } = useCustomerNames();
  ...
  const updateTransaction = async () => {
    ...
    try {
      ...
      if (!newTransaction.change_balance || isNaN(delta)) {
        setErrors((errors2) => ({ ...errors2, insufficient: "Amount is required and must be a valid number." }));
        return false;
      } else if (!payment.add && !payment.sub) {
        setErrors((errors2) => ({ ...errors2, insufficient: "Indicate transaction type." }));
        return false;
      } else if (!newTransaction.employee_name?.trim()) {
        setErrors((errors2) => ({ ...errors2, noEmployee: "Please enter your name!" }));
        return false;
      }
      const transactionData = {
        ...newTransaction,
        customer_id: customer.customer_id,
        date: (/* @__PURE__ */ new Date()).toLocaleString("en-US", { timeZone: "America/New_York" })
      };
      const result = await handleTransaction(transactionData, customer);
      if (!result) {
        setErrors((prev2) => ({ ...prev2, insufficient: "Transaction failed - no response received" }));
        return false;
      } else if (result.error) {
        setErrors((prev2) => ({ ...prev2, insufficient: result.error.message || "Transaction failed" }));
        return false;
      }
      await Promise.all([
      ...
      setErrors((prev2) => ({ ...prev2, insufficient: error.message || "An unexpected error occurred during the transaction" }));
      return false;
    } finally {
      setIsSubmitting(false);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Prompt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptTitle, { label: "New Transaction" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Amount", error: errors.insufficient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PromptInput,
        {
          type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Employee Name", error: errors.noEmployee, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Notes", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-4 mt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PromptButton,
        {
          onClick: handleSubmit,
...
function Report() {
  const { customers } = useCustomerNames();
  const { setDisplay } = useDisplay();
  const [outstanding, setOutstanding] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Prompt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptTitle, { label: "SYSTEM INFORMATION" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Number of Customers:", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: customers.length }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Total Credit Across All Customers:", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: customers.reduce((total, customer) => total + customer.balance, 0).toLocaleString("en-US", { style: "currency", currency: "USD" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Number of Outstanding Individuals:", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: outstanding || 0 }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptButton, { onClick: () => setDisplay("default"), className: "bg-red-500 cursor-pointer hover:", children: "Close" })
  ] });
}
function EditCustomer() {
  ...
  const { setDisplay } = useDisplay();
  const { setCustomers } = useCustomerNames();
  const [temp, setTemp] = reactExports.useState(customer);
  const [errors, setErrors] = reactExports.useState({});
  const [isSubmitting, setIsSubmitting] = reactExports.useState(false);
  ...
  const validate = (customer2) => {
    const errs = {};
    const { first_name, last_name, email, phone } = customer2;
    if (!first_name?.trim()) {
      errs.first_name = "First name is required";
    } else if (first_name.trim().length < 2) {
      errs.first_name = "First name must be at least 2 characters";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Prompt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptTitle, { label: "Edit Customer Information" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "First Name", error: errors.first_name, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
        type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PromptField, { label: "Phone Number", error: errors.phone, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PromptInput,
      {
        type: "tel",
        name: "phone",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute grid grid-cols-[25%_74%] md:grid-cols-[25%_74.5%] gap-[1%] md:gap-[0.5%] w-full h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerInfo, {})
    ] }),
    display === "user" && /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerPrompt, {}),
    display === "transaction" && /* @__PURE__ */ jsxRuntimeExports.jsx(TransactionPrompt, {}),
    display === "report" && /* @__PURE__ */ jsxRuntimeExports.jsx(Report, {}),
    display === "edit" && /* @__PURE__ */ jsxRuntimeExports.jsx(EditCustomer, {})
  ] });
}
var client = { exports: {} };
...
const CustomerProvider = ({ children }) => {
  ...
  const CustomerObject = reactExports.useMemo(() => ({ customer, setCustomer }), [customer, setCustomer]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerContext.Provider, { value: CustomerObject, children });
};
CustomerProvider.propTypes = {
  children: PropTypes.node.isRequired
};
const DisplayProvider = ({ children }) => {
  const [display, setDisplay] = reactExports.useState("default");
  const DisplayObject = reactExports.useMemo(() => ({ display, setDisplay }), [display, setDisplay]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DisplayContext.Provider, { value: DisplayObject, children });
};
...
const CustomerNamesProvider = ({ children }) => {
  ...
  const CustomerNamesObject = reactExports.useMemo(() => ({ customers, setCustomers }), [customers, setCustomers]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerNamesContext.Provider, { value: CustomerNamesObject, children });
};
...
const TransactionProvider = ({ children }) => {
  ...
  const TransactionObject = reactExports.useMemo(() => {
    return { transaction, setTransaction };
  }, [transaction, setTransaction]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TransactionContext.Provider, { value: TransactionObject, children });
};
TransactionProvider.propTypes = {
  children: PropTypes.node.isRequired
};
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DisplayProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomerNamesProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TransactionProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) }) }) }) })
);
